# Releasing FS User Stories 1.0.8 for macOS
...
- `Distribution/FS-User-Stories-1.0.8.dmg`
...
```sh
xcrun notarytool submit "Distribution/FS-User-Stories-1.0.8.dmg" \
  --keychain-profile "FSUserStories-Notary" --wait

xcrun stapler staple "Distribution/FS-User-Stories-1.0.8.dmg"
xcrun stapler validate "Distribution/FS-User-Stories-1.0.8.dmg"
spctl --assess --type open --context context:primary-signature \
  --verbose=2 "Distribution/FS-User-Stories-1.0.8.dmg"
```
