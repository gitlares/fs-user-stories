# Releasing FS User Stories 1.0.5 for macOS
...
- `Distribution/FS-User-Stories-1.0.5.dmg`
...
```sh
xcrun notarytool submit "Distribution/FS-User-Stories-1.0.5.dmg" \
  --keychain-profile "FSUserStories-Notary" --wait

xcrun stapler staple "Distribution/FS-User-Stories-1.0.5.dmg"
xcrun stapler validate "Distribution/FS-User-Stories-1.0.5.dmg"
spctl --assess --type open --context context:primary-signature \
  --verbose=2 "Distribution/FS-User-Stories-1.0.5.dmg"
```
