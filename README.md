...
Alpha 2 exposes 27 tools covering the product's real operations:
...
Alpha 2 currently requires an Apple Silicon Mac running macOS 26 or later.
...
**Alpha 2 is an early macOS release for real-world testing with small teams.**
